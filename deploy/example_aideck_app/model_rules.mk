...
$(MODEL_GEN_EXE): $(CNN_GEN) $(MODEL_BUILD)/$(MODEL_SRC) $(EXTRA_GENERATOR_SRC) | $(MODEL_BUILD)
	...
	gcc -g -o $(MODEL_GEN_EXE) -I. -I$(TILER_INC) -I$(TILER_EMU_INC) $(CNN_GEN_INCLUDE) $(CNN_LIB_INCLUDE) -lm $^ $(TILER_LIB) $(SDL_FLAGS)
...
# A phony target to s plify including this in the main Makefile
model: $(MODEL_GEN_C)
...
.PHONY: model clean_model clean_train train nntool_gen nntool_state tflite compile_model
