...
class MainWindow(QtWidgets.QWidget):
    ...
    def start_storing_images(self):
        print("Starting image collection...")
        self._imgDownload.start_collecting()

    def stop_storing_images(self):
        print("Stopping image collection...")
        self._imgDownload.stop_collecting()
...
if __name__ == '__main__':
    ...
    # Actions to start and stop image collection
    win.start_storing_images()  # Manually start image collection
    time.sleep(10)  # Collect images for 10 seconds
    win.stop_storing_images()  # Manually stop image collection
